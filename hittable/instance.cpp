...
Instance::Instance(const std::shared_ptr<Hittable> &object, const Vec3 &t, const Vec3 &r,
                   const Vec3 &s
)
...
bool Instance::hit(const ray &r, Interval rayT, hitRecord &rec) const
{
...
Vec3 Instance::transformVec3(const glm::mat4& m, const glm::vec3& v, float w) {
